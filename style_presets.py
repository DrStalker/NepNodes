STYLE_PRESETS = {        
		...
		"Biomechanical-Surrealism": {
			"prefix": "dark biomechanical surrealism, skeletal organic machinery fused with industrial forms, pale bone-like materials merged with tubes and cables, smooth bio-metal textures, elongated forms, haunting anatomical structures",
			"suffix":"somber monochrome palette, intricate mechanical ribs and tendons, sinister atmospheric shading, nightmarish alien architecture, engraved organic patterns, oppressive surreal tone"},
		"Organic-Biotech": {
		...
		"Giger-Like": {
			"prefix": "biomechanical dark surrealism with intricate organic machinery,flowing bio-metal structures,",
			"suffix": "gothic techno-organic atmosphere, alien textures, eerie synthetic-organic fusion, mt"},    
		"80s-Cartoons": {
