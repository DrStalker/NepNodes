STYLE_PRESETS = {
    ...
    "General":
    {
        ...
        "Nebula Witchcraft": {         # I ask an LLM to make the weirest styles it could think of....this is the only one that worth keeping
